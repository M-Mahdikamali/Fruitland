...
public class Select_the_value extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Integer.parseInt(textViewPerfect.getText().toString()) ==0 ||Integer.parseInt(textViewGood.getText().toString()) ==0 ||Integer.parseInt(textViewMean.getText().toString()) ==0 ){
                    Toast.makeText(Select_the_value.this,"تعداد مورد نظر خود را انتخاب کنید.",Toast.LENGTH_LONG).show();
                    return;
                }else {
                    Toast.makeText(Select_the_value.this, "به سبد خرید شما اضافه شد.", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
